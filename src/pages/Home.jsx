...
const HeroSection = () => (
  <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-20 text-center px-6 max-w-4xl">
      ...
      <button className="bg-yellow-500 text-black px-10 py-4 rounded-full font-bold uppercase text-xs tracking-widest hover:bg-white transition-all">
        Explore Collection
      </button>
    </div>
  </section>
            ...
            <div key={watch.id} className="group cursor-pointer">
              <div className="relative overflow-hidden aspect-3/4 bg-gray-900 rounded-2xl mb-4">
                ...
                <button
                  ...
                  className="absolute bottom-4 left-4 right-4 bg-white text-black py-3 rounded-xl font-bold text-[10px] uppercase translate-y-20 group-hover:translate-y-0 transition duration-500 hover:bg-yellow-500"
                >
                  Add to Cart
                </button>
              </div>
              <h3 className="font-bold text-lg">{watch.name}</h3>
              <p className="text-yellow-500 font-mono tracking-tighter">
