    ...
    <footer className="bg-black border-t border-gray-900 pt-16 pb-8 px-6 mt-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-black text-yellow-500 tracking-tighter uppercase">
            Time Fusion
          </h2>
          <p className="text-gray-500 text-sm leading-relaxed">
            Crafting elegance since 2026. We provide the world's finest
            timepieces for those who value every second.
          </p>
